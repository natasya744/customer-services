...
This file is the source of truth for any coding agent (Claude Code, Cursor, VScode, etc.) working in this repo. Read it before touching code.

## Stack

- **Backend:** Python + FastAPI + Whatsapp API (Evolution API)
...
- **Auth:** Supabase Auth
- **Hosting:** Vps using hostinger with docker container will be provided
