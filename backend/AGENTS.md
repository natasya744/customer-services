...
This is the FastAPI service for Customer service App. Read [../AGENTS.md](../AGENTS.md) first — universal building rules live there. This file adds backend-specific conventions.
...
- Evolution API Whatsapp provided
